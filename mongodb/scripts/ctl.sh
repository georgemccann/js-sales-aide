...
MONGODB_PIDFILE=/opt/bitnami/mongodb/tmp/mongodb.pid
MONGODB_LOCKFILE=/opt/bitnami/mongodb/data/db/mongod.lock
MONGODB_CONFIG_FILE=/opt/bitnami/mongodb/mongodb.conf
MONGODB_SERVER=/opt/bitnami/mongodb/bin/mongod
MONGODB_LOGFILE=/opt/bitnami/mongodb/log/mongodb.log
MONGODB_PORT=27017
MONGODB_STATUS=""
MONGODB_PID=""
